...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    try {
        ...
        `);
                stmt.run(id, taskArgs.projectId, taskArgs.title, description, taskArgs.startDate, taskArgs.duration, plannedStartDate, plannedDuration, progress, status, steps, taskTypeId);
                return {
                    content: [
                        {
                            type: 'text',
            ...
            case 'update_task': {
                ...
                const task = checkStmt.get(updateArgs.id);
                if (!task) {
                ...
                // Fetch updated task
                const updatedTask = checkStmt.get(updateArgs.id);
